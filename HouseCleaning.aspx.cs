...
public partial class HouseCleaning : System.Web.UI.Page
{
    ...
    private void BindListView()
    {
        ...
        using (SqlConnection con = new SqlConnection(connectionString))
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("SELECT ServiceID, Service,ImagePath FROM Services_Table where ServiceTypeID='3'", con))
                {
